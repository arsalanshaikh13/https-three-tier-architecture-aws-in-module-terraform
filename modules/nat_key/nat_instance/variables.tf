...
# }
variable "nat_ami_type" {
  type        = string
  description = "nat_ami_type variable"
}
variable "nat_ami_virtualization_type" {
  type        = string
  description = "nat_ami_virtualization_type variable"
}
variable "nat_ami_owner" {
  type        = string
  description = "nat_ami_owner variable"
}
...
variable "nat_bastion_key_name" {
  type        = string
  description = "nat_bastion_key_name variable"
}
