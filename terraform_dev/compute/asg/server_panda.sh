...
sudo sed -i "s/<region>/${aws_region}/g" /home/${ssh_username}/app-tier/DbConfig.js
sudo sed -i "s/<environment>/${environment}/g" /home/${ssh_username}/app-tier/DbConfig.js
# sudo sed -i "s/<secret-name>/<db_secret_name>/g" /home/${ssh_username}/app-tier/appdb.sql
sudo sed -i "s/<react_node_app>/${db_name}/g" /home/${ssh_username}/app-tier/appdb.sql
