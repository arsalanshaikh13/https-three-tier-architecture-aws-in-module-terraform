...
terraform {
  ...
  source = "tfr://gitlab.com/arsalanshaikh13/tf-modules-panda-user-data/aws//network/vpc?version=1.0.0-data-route53"
  # Notice the git:: prefix and the https protocol
  # source = "git::https://gitlab.com/arsalanshaikh13/tf-modules-panda-user-data.git//modules/network/vpc?ref=main"
  # source = "git::ssh://git@gitlab.com/arsalanshaikh13/tf-modules-panda-user-data.git//modules/network/vpc?ref=main"
  # source = "git::https://github.com/arsalanshaikh13/https-three-tier-architecture-aws-in-module-terraform.git//modules/network/vpc?ref=v1-terragrunt"
  # source = "git::ssh://git@github.com/arsalanshaikh13/https-three-tier-architecture-aws-in-module-terraform.git//modules/network/vpc?ref=v1-terragrunt"
