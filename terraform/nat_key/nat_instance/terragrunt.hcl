...
terraform {
  ...
  source = "tfr://gitlab.com/arsalanshaikh13/tf-modules-panda-user-data/aws//nat_key/nat_instance?version=1.0.0-key-ssh"
  # Notice the git:: prefix and the https protocol
  # source = "git::https://gitlab.com/arsalanshaikh13/tf-modules-panda-user-data.git//modules/nat_key/nat_instance?ref=main"
  # source = "git::ssh://git@gitlab.com/arsalanshaikh13/tf-modules-panda-user-data.git//modules/nat_key/nat_instance?ref=main"
  # source = "git::https://github.com/arsalanshaikh13/https-three-tier-architecture-aws-in-module-terraform.git//modules/nat_key/nat_instance?ref=v1-terragrunt"
  # source = "git::ssh://git@github.com/arsalanshaikh13/https-three-tier-architecture-aws-in-module-terraform.git//modules/nat_key/nat_instance?ref=v1-terragrunt"
...
dependency "iam_role" {
  # config_path                             = "../permissions/iam_role"
