...
terraform {
  ...
  source = "tfr://gitlab.com/arsalanshaikh13/tf-modules-panda-user-data/aws//database/aws_secret?version=1.0.0-data-route53"
  ...
  # source = "git::https://github.com/arsalanshaikh13/https-three-tier-architecture-aws-in-module-terraform.git//modules/database/aws_secret?ref=v1-terragrunt"
  # source = "git::ssh://git@github.com/arsalanshaikh13/https-three-tier-architecture-aws-in-module-terraform.git//modules/database/aws_secret?ref=v1-terragrunt"
